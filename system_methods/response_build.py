...
def pefil_success(cod, bio, uf, cidade, foto, id_prestador):

    nome, id = get_transp_info(id_prestador)
    
    respJson = jsonify(
        {"COD": cod, "PERFIL_INFO": {"BIO": bio,"UF": uf, "CIDADE": cidade, "FOTO": foto, "NOME": nome, "ID": id}}
